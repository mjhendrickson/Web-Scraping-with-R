...
options(htmltools.dir.version = FALSE, echo = FALSE, warning=FALSE)
library(tidyverse)
library(robotstxt)
library(rvest)
```
...
- Dataquest (unknown). "Tutorial: Web Scraping in R with rvest." [https://www.dataquest.io/blog/web-scraping-in-r-rvest/](https://www.dataquest.io/blog/web-scraping-in-r-rvest/).
