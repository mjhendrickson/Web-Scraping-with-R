...
2. Scraping Methods
3. Data Assembly
4. All elements - ueven number of records
...
Unfortunately, there are multiple formats and prices for each title. Here's we'll create additional title records for creating the dataset.
...
## Not all titles have rating counts

We must adjust for this. I'll do this manually by appending NA where rating counts are missing.
